...
abstract class CoincidenceLogic_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_TestApi extends BridgeTestSuite[CoincidenceLogic_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_Bridge](Arch.rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic) {
  ...
  /** helper function to check CoincidenceLogic_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic's
