...
object Arch {
  val rts_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic : RTS.Actuation.CoincidenceLogic_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 0, name = "rts_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 1, name = "rts_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_ports_channel2", mode = DataIn)
    val ports_channel3 = Port[Base_Types.Boolean] (id = 2, name = "rts_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_ports_channel3", mode = DataIn)
    val ports_channel4 = Port[Base_Types.Boolean] (id = 3, name = "rts_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_ports_channel4", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 4, name = "rts_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic : RTS.Actuation.CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 5, name = "rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 6, name = "rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_ports_channel2", mode = DataIn)
    val ports_channel3 = Port[Base_Types.Boolean] (id = 7, name = "rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_ports_channel3", mode = DataIn)
    val ports_channel4 = Port[Base_Types.Boolean] (id = 8, name = "rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_ports_channel4", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 9, name = "rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic : RTS.Actuation.CoincidenceLogic_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 10, name = "rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 11, name = "rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_ports_channel2", mode = DataIn)
    val ports_channel3 = Port[Base_Types.Boolean] (id = 12, name = "rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_ports_channel3", mode = DataIn)
    val ports_channel4 = Port[Base_Types.Boolean] (id = 13, name = "rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_ports_channel4", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 14, name = "rts_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic : RTS.Actuation.OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 15, name = "rts_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 16, name = "rts_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_ports_channel2", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 17, name = "rts_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic : RTS.Actuation.CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 18, name = "rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 19, name = "rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_ports_channel2", mode = DataIn)
    val ports_channel3 = Port[Base_Types.Boolean] (id = 20, name = "rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_ports_channel3", mode = DataIn)
    val ports_channel4 = Port[Base_Types.Boolean] (id = 21, name = "rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_ports_channel4", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 22, name = "rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic : RTS.Actuation.CoincidenceLogic_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 23, name = "rts_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 24, name = "rts_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_ports_channel2", mode = DataIn)
    val ports_channel3 = Port[Base_Types.Boolean] (id = 25, name = "rts_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_ports_channel3", mode = DataIn)
    val ports_channel4 = Port[Base_Types.Boolean] (id = 26, name = "rts_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_ports_channel4", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 27, name = "rts_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic : RTS.Actuation.CoincidenceLogic_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 28, name = "rts_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 29, name = "rts_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_ports_channel2", mode = DataIn)
    val ports_channel3 = Port[Base_Types.Boolean] (id = 30, name = "rts_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_ports_channel3", mode = DataIn)
    val ports_channel4 = Port[Base_Types.Boolean] (id = 31, name = "rts_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_ports_channel4", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 32, name = "rts_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic : RTS.Actuation.OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 33, name = "rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 34, name = "rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_ports_channel2", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 35, name = "rts_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic : RTS.Actuation.OrLogic_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 36, name = "rts_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 37, name = "rts_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic_ports_channel2", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 38, name = "rts_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator : RTS.Actuation.Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Bridge = {
    val ports_input = Port[Base_Types.Boolean] (id = 39, name = "rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_ports_input", mode = DataIn)
    val ports_manualActuatorInput = Port[Base_Types.Boolean] (id = 40, name = "rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_ports_manualActuatorInput", mode = DataIn)
    val ports_output = Port[Base_Types.Boolean] (id = 41, name = "rts_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_ports_output", mode = DataOut)
  ...
  val rts_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic : RTS.Actuation.OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Bridge = {
    val ports_channel1 = Port[Base_Types.Boolean] (id = 42, name = "rts_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_ports_channel1", mode = DataIn)
    val ports_channel2 = Port[Base_Types.Boolean] (id = 43, name = "rts_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_ports_channel2", mode = DataIn)
    val ports_actuate = Port[Base_Types.Boolean] (id = 44, name = "rts_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_ports_actuate", mode = DataOut)
  ...
  val rts_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator : RTS.Actuation.Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Bridge = {
    val ports_input = Port[Base_Types.Boolean] (id = 45, name = "rts_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_ports_input", mode = DataIn)
    val ports_manualActuatorInput = Port[Base_Types.Boolean] (id = 46, name = "rts_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_ports_manualActuatorInput", mode = DataIn)
    val ports_output = Port[Base_Types.Boolean] (id = 47, name = "rts_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_ports_output", mode = DataOut)
  ...
  val rts_instrumentationMock_instrumentationMockThread : RTS.Instrumentation.InstrumentationMockThread_instrumentationMock_instrumentationMockThread_Bridge = {
    val ports_unit1_temperatureLogic_channel1 = Port[Base_Types.Boolean] (id = 48, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_temperatureLogic_channel1", mode = DataOut)
    val ports_unit1_temperatureLogic_channel2 = Port[Base_Types.Boolean] (id = 49, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_temperatureLogic_channel2", mode = DataOut)
    val ports_unit1_temperatureLogic_channel3 = Port[Base_Types.Boolean] (id = 50, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_temperatureLogic_channel3", mode = DataOut)
    val ports_unit1_temperatureLogic_channel4 = Port[Base_Types.Boolean] (id = 51, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_temperatureLogic_channel4", mode = DataOut)
    val ports_unit1_pressureLogic_channel1 = Port[Base_Types.Boolean] (id = 52, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_pressureLogic_channel1", mode = DataOut)
    val ports_unit1_pressureLogic_channel2 = Port[Base_Types.Boolean] (id = 53, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_pressureLogic_channel2", mode = DataOut)
    val ports_unit1_pressureLogic_channel3 = Port[Base_Types.Boolean] (id = 54, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_pressureLogic_channel3", mode = DataOut)
    val ports_unit1_pressureLogic_channel4 = Port[Base_Types.Boolean] (id = 55, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_pressureLogic_channel4", mode = DataOut)
    val ports_unit1_saturationLogic_channel1 = Port[Base_Types.Boolean] (id = 56, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_saturationLogic_channel1", mode = DataOut)
    val ports_unit1_saturationLogic_channel2 = Port[Base_Types.Boolean] (id = 57, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_saturationLogic_channel2", mode = DataOut)
    val ports_unit1_saturationLogic_channel3 = Port[Base_Types.Boolean] (id = 58, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_saturationLogic_channel3", mode = DataOut)
    val ports_unit1_saturationLogic_channel4 = Port[Base_Types.Boolean] (id = 59, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit1_saturationLogic_channel4", mode = DataOut)
    val ports_unit2_temperatureLogic_channel1 = Port[Base_Types.Boolean] (id = 60, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_temperatureLogic_channel1", mode = DataOut)
    val ports_unit2_temperatureLogic_channel2 = Port[Base_Types.Boolean] (id = 61, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_temperatureLogic_channel2", mode = DataOut)
    val ports_unit2_temperatureLogic_channel3 = Port[Base_Types.Boolean] (id = 62, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_temperatureLogic_channel3", mode = DataOut)
    val ports_unit2_temperatureLogic_channel4 = Port[Base_Types.Boolean] (id = 63, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_temperatureLogic_channel4", mode = DataOut)
    val ports_unit2_pressureLogic_channel1 = Port[Base_Types.Boolean] (id = 64, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_pressureLogic_channel1", mode = DataOut)
    val ports_unit2_pressureLogic_channel2 = Port[Base_Types.Boolean] (id = 65, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_pressureLogic_channel2", mode = DataOut)
    val ports_unit2_pressureLogic_channel3 = Port[Base_Types.Boolean] (id = 66, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_pressureLogic_channel3", mode = DataOut)
    val ports_unit2_pressureLogic_channel4 = Port[Base_Types.Boolean] (id = 67, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_pressureLogic_channel4", mode = DataOut)
    val ports_unit2_saturationLogic_channel1 = Port[Base_Types.Boolean] (id = 68, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_saturationLogic_channel1", mode = DataOut)
    val ports_unit2_saturationLogic_channel2 = Port[Base_Types.Boolean] (id = 69, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_saturationLogic_channel2", mode = DataOut)
    val ports_unit2_saturationLogic_channel3 = Port[Base_Types.Boolean] (id = 70, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_saturationLogic_channel3", mode = DataOut)
    val ports_unit2_saturationLogic_channel4 = Port[Base_Types.Boolean] (id = 71, name = "rts_instrumentationMock_instrumentationMockThread_ports_unit2_saturationLogic_channel4", mode = DataOut)
  ...
  val rts_eventControlMock_eventControlMockThread : RTS.EventControl.EventControlMockThread_eventControlMock_eventControlMockThread_Bridge = {
    val ports_manualActuatorInput1 = Port[Base_Types.Boolean] (id = 72, name = "rts_eventControlMock_eventControlMockThread_ports_manualActuatorInput1", mode = DataOut)
    val ports_manualActuatorInput2 = Port[Base_Types.Boolean] (id = 73, name = "rts_eventControlMock_eventControlMockThread_ports_manualActuatorInput2", mode = DataOut)
  ...
  val rts_actuatorsMock_actuatorsMockThread : RTS.Actuators.ActuatorsMockThread_actuatorsMock_actuatorsMockThread_Bridge = {
    val ports_tempPressureActuate = Port[Base_Types.Boolean] (id = 74, name = "rts_actuatorsMock_actuatorsMockThread_ports_tempPressureActuate", mode = DataIn)
    val ports_saturationActuate = Port[Base_Types.Boolean] (id = 75, name = "rts_actuatorsMock_actuatorsMockThread_ports_saturationActuate", mode = DataIn)
