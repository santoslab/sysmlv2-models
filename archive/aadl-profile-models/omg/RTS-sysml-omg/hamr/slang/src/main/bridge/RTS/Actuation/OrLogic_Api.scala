...
@datatype class OrLogic_Initialization_Api (
  val id: Art.BridgeId,
  val ports_channel1_Id : Art.PortId,
  val ports_channel2_Id : Art.PortId,
  val ports_actuate_Id : Art.PortId) extends OrLogic_Api

@datatype class OrLogic_Operational_Api (
  val id: Art.BridgeId,
  val ports_channel1_Id : Art.PortId,
  val ports_channel2_Id : Art.PortId,
  val ports_actuate_Id : Art.PortId) extends OrLogic_Api {
