...
abstract class OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_TestApi extends BridgeTestSuite[OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Bridge](Arch.rts_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic) {
  ...
  /** helper function to check OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic's
