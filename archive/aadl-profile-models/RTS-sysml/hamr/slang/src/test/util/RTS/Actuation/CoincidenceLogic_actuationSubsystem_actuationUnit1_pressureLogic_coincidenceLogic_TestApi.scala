...
abstract class CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_TestApi extends BridgeTestSuite[CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_Bridge](Arch.rts_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic) {
  ...
  /** helper function to check CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic's
