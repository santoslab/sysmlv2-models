...
import art._
import RTS._
import RTS.Actuation.{CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic => component}

// This file was auto-generated.  Do not edit

@datatype class CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : CoincidenceLogic_Initialization_Api = {
    ...
    CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : CoincidenceLogic_Operational_Api = {
    ...
    CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge.EntryPoints(
      id,
...
object CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge {
  ...
  @datatype class EntryPoints(
    CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_BridgeId : Art.BridgeId,
