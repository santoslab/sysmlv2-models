...
import art._
import RTS._
import RTS.Actuation.{OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic => component}

// This file was auto-generated.  Do not edit

@datatype class OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : OrLogic_Initialization_Api = {
    ...
    OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : OrLogic_Operational_Api = {
    ...
    OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge.EntryPoints(
      id,
...
object OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Bridge {
  ...
  @datatype class EntryPoints(
    OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_BridgeId : Art.BridgeId,
