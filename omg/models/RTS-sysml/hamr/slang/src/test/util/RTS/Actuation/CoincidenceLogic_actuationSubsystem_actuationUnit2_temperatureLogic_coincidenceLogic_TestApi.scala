...
abstract class CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_TestApi extends BridgeTestSuite[CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Bridge](Arch.rts_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic) {
  ...
  /** helper function to check CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic's
  ...
  def put_ports_channel3(value : Base_Types.Boolean): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.operational_api.ports_channel3_Id, Base_Types.Boolean_Payload(value))
  }

  // setter for in DataPort
  def put_ports_channel4(value : Base_Types.Boolean): Unit = {
    ArtNative_Ext.insertInPortValue(bridge.operational_api.ports_channel4_Id, Base_Types.Boolean_Payload(value))
  }
